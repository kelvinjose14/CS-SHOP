...
Versión documentada: **1.1.0** (26/09/2026, para el piloto en la tienda), más lo hecho después para el piloto (O6). Los cambios de cada versión están en el [CHANGELOG](../CHANGELOG.md).
